...
typeName1 ='opendata:public_odl_brutto_1h'
typeName2 = 'opendata:public_precipitation_15min'
...
def getPrecipitation_15min(locality_code):
    ...
    #url = "https://entw-imis.lab.bfs.de/ogc/opendata/wfs?typeName="+typeName2+"&_dc=1665655122146&service=WFS&version=1.1.0&request=GetFeature&outputFormat=application%2Fjson&srsname=EPSG%3A3857&cql_filter=id%20%3D%20%27"+locality_code+"%27%20AND%20end_measure%3E%272023-02-25T00%3A00%3A00.000Z%27%20AND%20end_measure%3C%272023-03-03T00%3A00%3A00.000Z%27"
