...
def MultiLinearRegression_Prediction(locality_code,start,end, effect1, effect2):
    ...
    for index in range(len(df_7days)):
        ...
        append_odl = float(
            df_M['b0'] + #b0
            df_M['b_Precipitation'] * (df_7days['Value_precipitation'][index] * float(effect1)) + #b1x1
            df_M['b_PrecipitationMinus2'] * (df_7days['Value_precipitationMinus2'][index] * float(effect2)) + #b2x2
            df_M[b_month_string] #b3x3
        )
